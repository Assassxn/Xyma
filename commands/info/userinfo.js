...
module.exports = {
    name: "profile",
    aliases: ["info", "details", "userinfo", "info", "i"],
    description: "display all your info",
    permissions: [],
    ...
    run: async (client, message, args) => {
        ...
        let embed = new MessageEmbed().setThumbnail(user.user.displayAvatarURL({ dynamic: true }));
        ...
        embed.setColor(user.displayHexColor === "#000000" ? "#E91015" : user.displayHexColor);
